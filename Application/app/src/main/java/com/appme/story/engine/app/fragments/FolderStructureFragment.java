...
import com.appme.story.engine.app.folders.holder.FolderHolder;
...
public class FolderStructureFragment extends Fragment implements ProjectFileContract.View {
    ...
    public static FolderStructureFragment newInstance(@NonNull File projectFile) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mProjectFile = (File) getArguments().getSerializable(CompileManager.PROJECT_FILE);
